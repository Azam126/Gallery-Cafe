...
<head>
    ...
    <title>Gallery Cafe | ABOUT US</title>
    ...
    <section class="about-us">
        ...
        <div class="about-us-container">
            <div class="about-us-content">
                ...
                <p> Welcome to gallery Cafe! We're passionate about bringing the vibrant flavors of Sri Lanka to your table.
    ...
    <section class="Our-story" id="OurStory">
        ...
        <div class="Our-story-container">
            ...
            <div class="Our-story-content">
                ...
                <p> At Gallery Cafe, our story began with a shared love for flavors that transcend borders.
                    It all started in a cozy kitchen where our founder, <strong>Kasun </strong>,
                    ...
                    Gallery Cafe was born. From humble beginnings, we've grown to multiple locations,
                    but our ethos remains unchanged: to offer a culinary voyage that brings together diverse cultures on every plate.
                    Each dish at Gallery Cafe reflects not just a recipe, but a story—a tale of tradition,
