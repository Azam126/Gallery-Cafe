...
<body>
    ...
    <!-- Navigation Bar -->
    <nav class="navbar">
        <h1 class="logo">THE <br> GALLERY <br>CAFE <i class="fa-solid fa-utensils"></i></h1>
        <ul class="nav-links">
    ...
    <header>
        <div class="header-content">
            ...
            <h3>At the gallery cafe,Immers yourself in a Culinary Journey,Where every dishes tells a<br> flavorful tale
                of
    ...
    <section class="locations">
        <div class="location-header">
            <p>Our Locations</p>
            <h1>Find The GALLERY CAFE Near You</h1>
            <p class="sub-text">Locate Your Nearest gallery cafe Spot for Delicious
